    ...
    return (
      <Container style={{}}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 30 }}>
          <View style={{backgroundColor:'#000',borderRadius:50,padding:7,opacity:0.5}}>
            <Icon name="add-outline" style={{ color: '#fff',opacity:1 }} />
          </View>
          <View style={{backgroundColor:'#000',borderRadius:50,padding:7}}>
