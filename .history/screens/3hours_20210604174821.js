            ...
            >
                <View style={{ flexDirection: 'row' }}>
                    <View style={{ ...styles.hourCont }}>
                        <Image
                            style={{ height: 100, width: 100 }}
                            source={{ uri: `https://openweathermap.org/img/wn/${currentWeather.hourly.weather[0].icon}@4x.png` }}
                        />
                        <Text style={{ ...styles.text }}>{Math.ceil(currentWeather.hourly.temp)}&deg;</Text>
                    </View>
