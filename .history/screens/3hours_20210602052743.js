        ...
        return (
            <View style={{ ...styles.card }}>
                <View style={{ ...styles.hourCont }}>
                    ...
                    />
                    <Text>{Math.ceil(currentWeather.list[0].main.temp)}&deg;</Text>
                </View>
                <View style={{ ...styles.hourCont }}>
                    ...
                    />
                    <Text>{Math.ceil(currentWeather.list[1].main.temp)}&deg;</Text>
                </View>
                <View style={{ ...styles.hourCont }}>
                    ...
                    />
                    <Text>{Math.ceil(currentWeather.list[2].main.temp)}&deg;</Text>
                </View>
                <View style={{ ...styles.hourCont }}>
                    ...
                    />
                    <Text>{Math.ceil(currentWeather.list[3].main.temp)}&deg;</Text>
                </View>
                <View style={{ ...styles.hourCont }}>
                    ...
                    />
                    <Text>{Math.ceil(currentWeather.list[4].main.temp)}&deg;</Text>
                </View>
            </View>
        );
    } else {
