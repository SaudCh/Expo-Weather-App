        ...
        return (
            <View style={{ ...styles.card }}>
                ...
                <View style={{ ...styles.hourCont }}>
                    ...
                    />
                    <Text>{Math.ceil(currentWeather.list[1].main.temp)}</Text>
                </View>
                <View style={{ ...styles.hourCont }}>
                    ...
                    />
                    <Text>{Math.ceil(currentWeather.list[2].main.temp)}</Text>
                </View>
                <View style={{ ...styles.hourCont }}>
                    ...
                    />
                    <Text>{Math.ceil(currentWeather.list[3].main.temp)}</Text>
                </View>
                <View style={{ ...styles.hourCont }}>
