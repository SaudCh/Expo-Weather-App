...
export default function App(props) {
    ...
    console.log(props.initialParams.city)
    //const { cityName } = props.initialParams;
    ...
    async function load() {
        try {
            ...
            const weatherURL = `${BASE_WEATHER_URL}q=${cityName}&units=${unitSystem}&appid=${WEATHER_API_KET}`
