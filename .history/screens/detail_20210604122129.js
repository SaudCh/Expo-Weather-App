  ...
  if (currentWeather) {
    ...
    return (
      <Container style={{}}>
        ...
        <ImageBackground
          source={require('../assets/img/back3.jpg')} style={{ ...styles.image, }}
        >
          <View style={{ backgroundColor: 'rgba(0,0,0,0.5)', flex: 1 }}>
            ...
            <Hours />
            <View style={{ zIndex:2, flexDirection: 'row', justifyContent: 'space-between', position: 'absolute', bottom: 50, left: 10, right: 10 }}>
              <Button transparent
